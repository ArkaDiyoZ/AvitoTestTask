...
- make build
- make run
- Открыть приложение (postman) и направить ряд желаемых запросов к сервису по иструкции описанной выше
